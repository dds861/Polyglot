...
public class DialogFragmentFirstUserEntranceExam extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        int heart_rating_default = getResources().getInteger(R.integer.heart_rating_default);

        builder.setMessage(getString(R.string.dialog_text_first, heart_rating_default, questions_rating_default))
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        if (checkBox.isChecked()) {
                            preferencesApp.onSaveBoolean(ConstantsApp.IS_SHOW_ALERT_DIALOG_ON_FIRST_USER_ENTRANCE_EXAM_KEY, true);
